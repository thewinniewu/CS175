...
static shared_ptr<SimpleGeometryPN> g_subdivSurface;
static Mesh g_subdivSurfaceMesh;
static Mesh g_currentSubdivSurfaceMesh;
...
static void initMaterials() {
  ...
  // specular for asst7 subdivisions
...
static void initScene() {
  ...
  g_meshNode->addChild(shared_ptr<MyShapeNode>(
    new MyShapeNode(g_subdivSurface, g_specularMat, Cvec3(0, 0, 0))));
